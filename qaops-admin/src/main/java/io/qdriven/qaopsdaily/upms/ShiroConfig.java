...
import io.qdriven.qaopsdaily.core.annotation.ConditionOnRedisCache;
...
public class ShiroConfig {
    ...
    public RedisCacheManager redisCacheManager() {
        ...
        redisCacheManager.setExpire((int) tOpsProps.getShiro().getSessionTimeout().getSeconds());
    ...
    private SimpleCookie rememberMeCookie() {
        ...
        cookie.setMaxAge((int) tOpsProps.getShiro().getCookieTimeout().getSeconds());
        return cookie;
    }
    ...
    public DefaultWebSessionManager sessionManager(@Nullable RedisSessionDAO redisSessionDAO,
        ...
        // 设置 session超时时间
        sessionManager.setGlobalSessionTimeout(tOpsProps.getShiro().getSessionTimeout().toMillis());
